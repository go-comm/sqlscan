...
func main() {
	...
	if *help {
		...
		// that way people can: sqlscan -h | less
		fmt.Println(usageText)
		return
	}

	if *version {
		fmt.Println("sqlscan version 1.2.0")
		return
	}
